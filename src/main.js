...
let terrainData=null,terrainVerticalOffset=0,regionalVerticalOffset=0,osmBuildingsOffset=0,osmRoadsOffset=0;
...
function clearImagery(){imageryGroup.traverse(o=>{o.geometry?.dispose();if(o.material)(Array.isArray(o.material)?o.material:[o.material]).forEach(m=>{m.map?.dispose();m.dispose()})});imageryGroup.clear();imageryGroup.position.z=0;invalidate()}
